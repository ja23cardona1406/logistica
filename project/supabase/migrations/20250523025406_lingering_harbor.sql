/*
  # Initial Schema Setup for Repremundo Customs Management System

  1. New Tables
    - profiles: User profiles extending Supabase auth
    - sessions: Work sessions tracking
    - shipments: Shipment tracking and details
    - shipment_items: Individual items in shipments
    - processes: Custom process definitions
    - process_steps: Steps within processes
    - process_executions: Process execution instances
    - process_step_executions: Individual step execution tracking
    - alerts: System alerts and notifications
    - exemplary_processes: Showcase of well-executed processes
    - assistant_logs: Virtual assistant interaction tracking
  ...
  3. Sample Data
    - Basic import/export processes
    - Example process steps
    - Exemplary process showcases
*/
